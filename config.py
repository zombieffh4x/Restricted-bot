...
MONGO_DB = getenv("MONGO_DB", "mongodb+srv://customersaverestrictionbot:customersaverestrictionbot@cluster06368074567.acuefvu.mongodb.net/?retryWrites=true&w=majority&appName=Cluster06368074567")
